...
const Item = () => {
	...
	const [ itemImg, setItemImg ] = useState('https://securecdn.pymnts.com/wp-content/uploads/2019/09/Tile-Google-Assistant-Integration.jpg');
		...
		<div>
			...
			<div className="item-container">
				...
				<div className="item-form">
					...
					<button className="item-btn-submit" onClick={onSubmit}>Post Item</button>
					</form>
				</div>
			</div>
		</div>
